  ...
  useEffect(() => {
    if (selectedAddressId && addresses.length > 0) {
      ...
      if (selectedAddress?.postalCode) {
        updateShippingOptions(selectedAddress.postalCode);
      }
    }
          ...
          <div className="relative z-10">
            <div className="relative flex justify-center">
              <div className="h-36 w-36 bg-[#166454]/10 rounded-full flex items-center justify-center mx-auto mb-6 animate-bounce">
                <PartyPopper
                  className={`h-20 w-20 text-[#166454] ${confettiCannon ? "animate-pulse" : ""
                    }`}
                />
              </div>
                ...
                {paymentSettings.cashEnabled && (
                  <div
                    className={`border rounded-md p-4 transition-all ${paymentMethod === "CASH"
                      ? "border-[#166454] bg-[#166454]/5 cursor-pointer"
                  ...
                  >
                    ...
                    <p className="text-sm mt-2 ml-6 text-gray-600">
                      ...
                      {paymentSettings.codCharge > 0 && (
                        <span className="block mt-1 text-[#166454] font-medium">
        ...
        <div className="lg:col-span-1">
          <div className="bg-white rounded-lg shadow-sm border p-6 sticky top-20">
            ...
            <div className="divide-y">
                ...
                {cart.shippingOptions && cart.shippingOptions.length > 0 && (
                  <div className="border-t pt-3 mt-3">
                    <h3 className="font-medium text-gray-900 mb-3 flex items-center">
                      <MapPin className="h-4 w-4 mr-2 text-[#166454]" />
                      Shipping Options
                    </h3>
                    <div className="space-y-2">
                      {cart.shippingOptions.map((option) => (
                        <div
                          key={option.id}
                          className={`border rounded-md p-3 transition-all cursor-pointer ${cart.selectedShippingOption?.id === option.id
                            ? "border-[#166454] bg-[#166454]/5"
                          ...
                          <div className="flex items-center justify-between">
                            <div className="flex items-center">
                              <input
                                type="radio"
                                name="shippingOption"
                                checked={cart.selectedShippingOption?.id === option.id}
                              ...
                              <div className="ml-3">
                                ...
                                <div className="text-xs text-gray-600">
                                  {option.etd && `Est. delivery: ${option.etd}`}
                                  {option.estimatedDelivery && ` (${option.estimatedDelivery} days)`}
                                </div>
                              </div>
                            </div>
                            <div className="font-medium text-[#166454]">
              ...
              <Button
                className={`w-full mt-6 bg-[#166454] hover:bg-[#0d4a3d] text-white transition-all duration-200 ${processing ? "shadow-lg" : "hover:shadow-lg"
                  }`}
                size="lg"
