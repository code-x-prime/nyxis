    ...
    <div className="max-w-4xl mx-auto py-10 px-4">
      <Card>
        <CardContent className="space-y-5 pt-6 text-gray-800">
          <p>
            Traya Life believes in helping its customers as far as
          ...
          <p>
            Traya Life does not accept cancellation requests for
          ...
          <p>
            In case of any Refunds approved by the Traya Life,
