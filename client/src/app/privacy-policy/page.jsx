    ...
    <div className="max-w-4xl mx-auto py-10 px-4">
      ...
      <Card>
        <CardContent className="space-y-5 pt-6 text-gray-800">
          ...
          <p className="text-lg">
            This privacy policy sets out how Traya Life uses and
            protects any information that you give Traya Life when you
            visit their website and/or agree to purchase from them.
          </p>

          <p className="text-lg">
            Traya Life is committed to ensuring that your privacy is
          ...
          <p className="text-lg">
            Traya Life may change this policy from time to time by
          ...
          <p className="mb-4">
            ...
            Haryana, 124105 Sondhi BO HARYANA 124105 or contact us at support@trayalife.com as soon as possible. We will
