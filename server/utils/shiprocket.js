 ...
 */
export async function processOrderForShipping(orderId, selectedShippingOption = null) {
    ...
    try {
        ...
        // Try to assign AWB
        try {
            const awbResponse = await assignAWB(shiprocketResponse.shipment_id, selectedShippingOption?.id);
