...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>We've received a request to delete your ${store.storeName} account. Before proceeding, we want to ensure this is your intended action, as it will affect your access to orders, history, and progress records.</p>
            ...
            <p>If you didn't request this deletion, please contact our support team immediately at ${store.supportEmail}.</p>
        </div>
        <div class="footer">
...
export const getFeeReceiptTemplate = (data, storeConfig = null) => {
    const store = storeConfig || getStoreConfig();
    return `
<!DOCTYPE html>
<html lang="en">
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>New Fee Assignment - Traya Life</title>
    <style>
        body {
            font-family: 'Arial', sans-serif;
            line-height: 1.6;
...
<body>
    ...
    data.dueDate
        ...
        <div class="footer">
            <p>© ${new Date().getFullYear()} Traya Life | Holistic Hair & Wellness Solutions</p>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Payment Successful - Traya Life</title>
    <style>
        body {
            font-family: 'Arial', sans-serif;
            line-height: 1.6;
...
<body>
    ...
    minute: "2-digit",
            ...
            <p>For any queries, please contact our support team at ${store.supportEmail}</p>
        </div>
    </div>
</body>
</html>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Payment Failed - Traya Life</title>
    <style>
        body {
            font-family: 'Arial', sans-serif;
            line-height: 1.6;
...
<body>
    ...
    "en-IN"
        ...
        <div class="footer">
            <p>© ${new Date().getFullYear()} ${store.storeName} | ${store.storeTagline}</p>
            <p>Need help? Contact our support team at ${store.supportEmail}</p>
        </div>
    </div>
</body>
</html>
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Certificate Generated - Traya Life</title>
    <style>
        body {
            font-family: 'Arial', sans-serif;
            line-height: 1.6;
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>New Contact Form Submission - Traya Life</title>
    <style>
        body {
            font-family: 'Arial', sans-serif;
            line-height: 1.6;
